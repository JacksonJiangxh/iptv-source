...
- **TR: BLUMAX** (出现 40 次): TR: BLUMAX  HD YESILCAM 3  HD,TR: BLUMAX HD KEMAL SUNAL 4 4K,TR: BLUMAX HD KEMAL SUNAL 5 HD
...
- **FANT** (出现 6 次): FANTHD1,FANTHD5,FANTHD6
...
> 共 134 条建议，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)
