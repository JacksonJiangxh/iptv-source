...
> 共 553 个未知分类，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)

## 📝 待添加到 alias.txt 的别名建议

以下频道名称建议添加别名映射：

- **TR: BLUMAX** (出现 40 次): TR: BLUMAX HD KEMAL SUNAL 2 4K,TR: BLUMAX HD KEMAL SUNAL 6 4K,TR: BLUMAX HD YESILCAM 4 4K
...
- **浙江新闻** (出现 7 次): 浙江新闻
- **FANT** (出现 7 次): FANTHD2,FANTHD4,FANTHD7
...
> 共 156 条建议，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)
