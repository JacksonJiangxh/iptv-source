...
> 共 536 个未知分类，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)

## 📝 待添加到 alias.txt 的别名建议

以下频道名称建议添加别名映射：

- **TR: BLUMAX** (出现 40 次): TR: BLUMAX  HD KEMAL SUNAL 3 HD,TR: BLUMAX HD KEMAL SUNAL 5 4K,TR: BLUMAX HD YESILCAM 6 HD
