...
> 共 611 个未知分类，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)

## 📝 待添加到 alias.txt 的别名建议

以下频道名称建议添加别名映射：

- **TR: BLUMAX** (出现 40 次): TR: BLUMAX HD ANKARA HAVALARI 2,TR: BLUMAX HD KADIR INANIR HD,TR: BLUMAX HD YESILCAM 7 4K
- 无主名 (出现 34 次): ,4K南国都市,4K电影 高清
- **熊猫** (出现 22 次): 熊猫频道1,熊猫频道3,熊猫频道9
...
> 共 228 条建议，完整列表见 [new-aliasdemo.txt](new-aliasdemo.txt)
